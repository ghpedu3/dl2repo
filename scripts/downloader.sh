...
[ "${__ENABLE_DOWNLOAD_TMP}" = "true" ] && {
    ...
    my_wget "https://newyork.kapeli.com/feeds/zzz/mdn/CSS.tgz" "" --no-verbose --referer="https://kapeli.com/mdn_offline/" --user-agent="Mozilla/5.0"
    my_wget "https://newyork.kapeli.com/feeds/zzz/mdn/HTML.tgz" "" --no-verbose --referer="https://kapeli.com/mdn_offline/" --user-agent="Mozilla/5.0"
    my_wget "https://newyork.kapeli.com/feeds/zzz/mdn/JavaScript.tgz" "" --no-verbose --referer="https://kapeli.com/mdn_offline/" --user-agent="Mozilla/5.0"
    my_wget "https://newyork.kapeli.com/feeds/zzz/mdn/HTTP.tgz" "" --no-verbose --referer="https://kapeli.com/mdn_offline/" --user-agent="Mozilla/5.0"
    my_wget "https://newyork.kapeli.com/feeds/zzz/mdn/SVG.tgz" "" --no-verbose --referer="https://kapeli.com/mdn_offline/" --user-agent="Mozilla/5.0"
