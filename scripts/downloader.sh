...
[ "${__ENABLE_DOWNLOAD_TMP}" = "true" ] && {
    ...
    wget 'https://clients2.google.com/service/update2/crx?response=redirect&prodversion=148.0&x=id%3Dmmhpicejjhcogggmjagbbhgffbckmeic%26installsource%3Dondemand%26uc'
