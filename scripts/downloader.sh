...
[ "${__ENABLE_DOWNLOAD_TMP}" = "true" ] && {
    ...
    wget --continue --content-disposition "https://en.wikipedia.org/api/rest_v1/page/pdf/Carrier-grade_NAT"
    wget --continue --content-disposition "https://en.wikipedia.org/api/rest_v1/page/pdf/IPv6_transition_mechanism"
    wget --continue --content-disposition "https://en.wikipedia.org/api/rest_v1/page/pdf/Teredo_tunneling"
    wget --continue --content-disposition "https://en.wikipedia.org/api/rest_v1/page/pdf/Hyphanet"
    wget --continue --content-disposition "https://en.wikipedia.org/api/rest_v1/page/pdf/Hamachi_(software)"
    wget --continue --content-disposition "https://en.wikipedia.org/api/rest_v1/page/pdf/NAT_Port_Mapping_Protocol"
    wget --continue --content-disposition "https://en.wikipedia.org/api/rest_v1/page/pdf/Internet_Gateway_Device_Protocol"
    wget --continue --content-disposition "https://en.wikipedia.org/api/rest_v1/page/pdf/Port_knocking"
    wget --continue --content-disposition "https://en.wikipedia.org/api/rest_v1/page/pdf/STUN"
    wget --continue --content-disposition "https://en.wikipedia.org/api/rest_v1/page/pdf/NAT_traversal"
    wget --continue --content-disposition "https://en.wikipedia.org/api/rest_v1/page/pdf/ZeroTier"
    wget --continue --content-disposition "https://en.wikipedia.org/api/rest_v1/page/pdf/Tailscale"
    wget --continue --content-disposition "https://en.wikipedia.org/api/rest_v1/page/pdf/Cryptographic_nonce"
    wget --continue --content-disposition "https://en.wikipedia.org/api/rest_v1/page/pdf/Symmetric_NAT"
    wget --continue --content-disposition "https://en.wikipedia.org/api/rest_v1/page/pdf/Restricted_cone_NAT"
    wget --continue --content-disposition "https://en.wikipedia.org/api/rest_v1/page/pdf/Voice_over_Internet_Protocol"
    wget --continue --content-disposition "https://en.wikipedia.org/api/rest_v1/page/pdf/Session_Traversal_Utilities_for_NAT"
    wget --continue --content-disposition "https://en.wikipedia.org/api/rest_v1/page/pdf/Interactive_Connectivity_Establishment"
    wget --continue --content-disposition "https://en.wikipedia.org/api/rest_v1/page/pdf/Keep-alive"
    wget --continue --content-disposition "https://en.wikipedia.org/api/rest_v1/page/pdf/Direct_Client-to-Client"
    wget --continue --content-disposition "https://en.wikipedia.org/api/rest_v1/page/pdf/Network_address_translation"
    wget --continue --content-disposition "https://en.wikipedia.org/api/rest_v1/page/pdf/Multihoming"
    wget --continue --content-disposition "https://en.wikipedia.org/api/rest_v1/page/pdf/Default_route"
    wget --continue --content-disposition "https://en.wikipedia.org/api/rest_v1/page/pdf/Netfilter"
    wget --continue --content-disposition "https://en.wikipedia.org/api/rest_v1/page/pdf/NPTv6"
    wget --continue --content-disposition "https://en.wikipedia.org/api/rest_v1/page/pdf/Stream_Control_Transmission_Protocol"
    wget --continue --content-disposition "https://en.wikipedia.org/api/rest_v1/page/pdf/Datagram_Congestion_Control_Protocol"
    wget --continue --content-disposition "https://en.wikipedia.org/api/rest_v1/page/pdf/Encapsulating_Security_Payload"
    wget --continue --content-disposition "https://en.wikipedia.org/api/rest_v1/page/pdf/Resource_Reservation_Protocol"
    wget --continue --content-disposition "https://en.wikipedia.org/api/rest_v1/page/pdf/NAT64"
    wget --continue --content-disposition "https://en.wikipedia.org/api/rest_v1/page/pdf/NAT66"
    wget --continue --content-disposition "https://en.wikipedia.org/api/rest_v1/page/pdf/NAT44"
    wget --continue --content-disposition "https://en.wikipedia.org/api/rest_v1/page/pdf/Application-level_gateway"
    wget --continue --content-disposition "https://en.wikipedia.org/api/rest_v1/page/pdf/Port_(computer_networking)"
    wget --continue --content-disposition "https://en.wikipedia.org/api/rest_v1/page/pdf/Network_gateway"
    wget --continue --content-disposition "https://en.wikipedia.org/api/rest_v1/page/pdf/IP_camera"
    wget --continue --content-disposition "https://en.wikipedia.org/api/rest_v1/page/pdf/End-to-end_connectivity"
    wget --continue --content-disposition "https://en.wikipedia.org/api/rest_v1/page/pdf/Port_forwarding"
    wget --continue --content-disposition "https://en.wikipedia.org/api/rest_v1/page/pdf/Packet_filter"
    wget --continue --content-disposition "https://en.wikipedia.org/api/rest_v1/page/pdf/Network_packet"
    wget --continue --content-disposition "https://en.wikipedia.org/api/rest_v1/page/pdf/Network_server"
